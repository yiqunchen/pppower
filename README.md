...
changes.
    ...
    #>  tz       US/Eastern
    #>  date     2025-10-08
    #>  pandoc   3.1.11.1 @ /users/mguo/.local/pandoc/bin/ (via rmarkdown)
    #>  quarto   NA
    #> 
    #> ─ Packages ───────────────────────────────────────────────────────────────────
    #>  package     * version    date (UTC) lib source
    #>  cachem        1.0.8      2023-05-01 [3] CRAN (R 4.3.1)
    #>  cli           3.6.1      2023-03-23 [3] CRAN (R 4.3.1)
    #>  devtools      2.4.5      2022-10-11 [3] CRAN (R 4.3.1)
    #>  digest        0.6.33     2023-07-07 [3] CRAN (R 4.3.1)
    #>  ellipsis      0.3.2      2021-04-29 [3] CRAN (R 4.3.1)
    #>  evaluate      1.0.5      2025-08-27 [2] CRAN (R 4.3.1)
    #>  fastmap       1.1.1      2023-02-24 [3] CRAN (R 4.3.1)
    #>  fs            1.6.3      2023-07-20 [3] CRAN (R 4.3.1)
    #>  glue          1.6.2      2022-02-24 [3] CRAN (R 4.3.1)
    #>  htmltools     0.5.6      2023-08-10 [3] CRAN (R 4.3.1)
    #>  htmlwidgets   1.6.2      2023-03-17 [3] CRAN (R 4.3.1)
    #>  httpuv        1.6.11     2023-05-11 [3] CRAN (R 4.3.1)
    #>  knitr         1.44       2023-09-11 [3] CRAN (R 4.3.1)
    #>  later         1.3.1      2023-05-02 [3] CRAN (R 4.3.1)
    #>  lifecycle     1.0.4      2023-11-07 [2] CRAN (R 4.3.1)
    #>  magrittr      2.0.3      2022-03-30 [3] CRAN (R 4.3.1)
    #>  memoise       2.0.1      2021-11-26 [3] CRAN (R 4.3.1)
    #>  mime          0.12       2021-09-28 [3] CRAN (R 4.3.1)
    #>  miniUI        0.1.2      2025-04-17 [2] CRAN (R 4.3.1)
    #>  pkgbuild      1.4.8      2025-05-26 [2] CRAN (R 4.3.1)
    #>  pkgload       1.4.1      2025-09-23 [2] CRAN (R 4.3.1)
    #>  pppower     * 0.0.0.9000 2025-10-08 [1] local
    #>  profvis       0.3.8      2023-05-02 [3] CRAN (R 4.3.1)
    #>  promises      1.2.1      2023-08-10 [3] CRAN (R 4.3.1)
    #>  purrr         1.0.2      2023-08-10 [3] CRAN (R 4.3.1)
    #>  R6            2.5.1      2021-08-19 [3] CRAN (R 4.3.1)
    #>  Rcpp          1.0.11     2023-07-06 [3] CRAN (R 4.3.1)
    #>  remotes       2.5.0      2024-03-17 [2] CRAN (R 4.3.1)
    #>  rlang         1.1.1      2023-04-28 [3] CRAN (R 4.3.1)
    #>  rmarkdown     2.30       2025-09-28 [2] CRAN (R 4.3.1)
    #>  sessioninfo   1.2.3      2025-02-05 [2] CRAN (R 4.3.1)
    #>  shiny         1.7.5      2023-08-12 [3] CRAN (R 4.3.1)
    #>  stringi       1.7.12     2023-01-11 [3] CRAN (R 4.3.1)
    #>  stringr       1.5.0      2022-12-02 [3] CRAN (R 4.3.1)
    #>  urlchecker    1.0.1      2021-11-30 [3] CRAN (R 4.3.1)
    #>  usethis       3.2.1      2025-09-06 [2] CRAN (R 4.3.1)
    #>  vctrs         0.6.3      2023-06-14 [3] CRAN (R 4.3.1)
    #>  xfun          0.40       2023-08-09 [3] CRAN (R 4.3.1)
    #>  xtable        1.8-4      2019-04-21 [3] CRAN (R 4.3.1)
    #>  yaml          2.3.7      2023-01-23 [3] CRAN (R 4.3.1)
    #> 
    #>  [1] /tmp/RtmpkTctlC/temp_libpath36b26b756fa70e
    #>  [2] /users/mguo/R/4.3
    #>  [3] /jhpce/shared/community/core/conda_R/4.3/R/lib64/R/site-library
    #>  [4] /jhpce/shared/community/core/conda_R/4.3/R/lib64/R/library
