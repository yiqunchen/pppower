...
n_required_ppi_pp(
  ...
  Sigma_Yf   = matrix(0, nrow = nrow(Sigma_YY_pop), ncol = ncol(Sigma_ff_pop))
)

n_star <- pppower:::n_required_ppi_pp_ols_closed(
  delta     = delta,
  N         = N,
  alpha     = 0.05,
  power     = target,
  ...
  H         = H_pop,
  Sigma_YY  = Sigma_YY_pop,
  Sigma_ff  = Sigma_ff_pop,  # single Σ_ff, same as in variance formula
  Sigma_Yf  = Sigma_Yf_pop
)
```
