...
subtitle: "Using `n_required_ppi_pp()` for mean (continuous/binary)"
output:
...
- How `n_required_ppi_pp()` works for mean estimation
...
For LLM-as-a-judge binary surrogates and EIF-based power, see the “LLM Judge”
article.
